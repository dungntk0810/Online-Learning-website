<%-- 
    Document   : lesson18
    Created on : Feb 4, 2023, 1:21:43 AM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        <div class="w3-col l10 m12" id="main">
            ...
            <p>The <code class="w3-codespan">IN</code> operator allows you to specify multiple values in a <code class="w3-codespan">
                    WHERE</code> clause.</p>
            <p>The <code class="w3-codespan">IN</code> operator is a shorthand for multiple <code class="w3-codespan">
                    OR</code> conditions.</p>
            ...
            <div class="w3-example">
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black">
                        ...
                        <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> <em>column_name</em> <span class="sqlkeywordcolor" style="color:mediumblue">IN</span> (<em>value1</em>,<em> value2</em>, ...); </span></div></div>
            <p>or:</p>
            <div class="w3-example">
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black">
                        <span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> <em>column_name(s)</em><br>
                        <span class="sqlkeywordcolor" style="color:mediumblue">FROM</span> <em>table_name</em><br>
                        <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> <em>column_name</em> <span class="sqlkeywordcolor" style="color:mediumblue">IN</span> (<em><span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> STATEMENT</em>); </span></div></div>
            <hr>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span>  <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> Country <span class="sqlkeywordcolor" style="color:mediumblue">IN</span> (<span class="sqlstringcolor" style="color:brown">'Germany'</span>, <span class="sqlstringcolor" style="color:brown">'France'</span>, <span class="sqlstringcolor" style="color:brown">'UK'</span>);<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>

            </div>

            <p>The following SQL statement selects all customers that are NOT located in "Germany", "France" or "UK":</p>
            <div class="w3-example">
                <h3>Example</h3>
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> * <span class="sqlkeywordcolor" style="color:mediumblue">FROM</span> Customers<br><span class="sqlnumbercolor" style="color:">
                        </span>  <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> Country <span class="sqlkeywordcolor" style="color:mediumblue">NOT</span> <span class="sqlkeywordcolor" style="color:mediumblue">IN</span> (<span class="sqlstringcolor" style="color:brown">'Germany'</span>, <span class="sqlstringcolor" style="color:brown">'France'</span>, <span class="sqlstringcolor" style="color:brown">'UK'</span>);<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span>  <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> Country <span class="sqlkeywordcolor" style="color:mediumblue">IN</span> (<span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> Country <span class="sqlkeywordcolor" style="color:mediumblue">FROM</span> Suppliers);<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>
