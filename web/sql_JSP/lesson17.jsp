<%-- 
    Document   : lesson17
    Created on : Feb 4, 2023, 1:18:59 AM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        <div class="w3-col l10 m12" id="main">
            ...
            <p>A wildcard character is used to substitute one or more characters in a string.</p>
            <p>Wildcard characters are used with the <code class="w3-codespan">
                    <a href="sql_like.asp">LIKE</a></code> 
                operator. The <code class="w3-codespan">LIKE</code> operator is used in a <code class="w3-codespan">
            ...
            <table class="ws-table-all notranslate">
                <tbody><tr>
                    ...
                    <tr>
                        ...
                        <td>2#5 finds 205, 215, 225, 235, 245, 255, 265, 275, 285, and 295</td>
                    </tr>
                </tbody></table>
            ...
            <p>All the wildcards can also be used in combinations!</p>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> City <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'ber%'</span>;  </span></div>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> City <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'%es%'</span>;<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>
            ...
            <p>The following SQL statement selects all customers with a City starting with 
                any character, followed by "ondon":</p>

            <div class="w3-example">
                <h3>Example</h3>
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> * <span class="sqlkeywordcolor" style="color:mediumblue">FROM</span> Customers<br><span class="sqlnumbercolor" style="color:">
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> City <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'_ondon'</span>;<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> City <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'L_n_on'</span>;<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> City <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'[bsp]%'</span>;<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> City <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'[a-c]%'</span>;<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>
            ...
            <p>The two following SQL statements select all customers with a City NOT starting 
                with "b", "s", or "p":</p>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> City <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'[!bsp]%'</span>; </span></div>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> City <span class="sqlkeywordcolor" style="color:mediumblue">NOT</span> <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'[bsp]%'</span>; </span></div>
