<%-- 
    Document   : lesson16
    Created on : Feb 4, 2023, 1:16:21 AM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        <div class="w3-col l10 m12" id="main">
            ...
            <p>The <code class="w3-codespan">LIKE</code> operator is used in a <code class="w3-codespan">
                    WHERE</code> clause to search for a specified pattern in a column.</p>
            <p>There are two wildcards often used in conjunction with the <code class="w3-codespan">
                    LIKE</code> operator:</p>
            <ul>
            ...
            <div class="w3-panel w3-note">
                <p><strong>Note:</strong> MS Access uses an asterisk (*) instead of the percent 
                    sign (%), and a question mark (?) instead of the underscore (_).</p>
            </div>
            ...
            <div class="w3-example">
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black">
                        <span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> <em>column1, column2, ...</em><br>
                        <span class="sqlkeywordcolor" style="color:mediumblue">FROM</span> <em>table_name</em><br>
                        <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> <em>columnN</em> <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <em>pattern</em>; </span></div></div>

            <div class="w3-panel w3-note">
                <p><strong>Tip:</strong> You can also combine any number of conditions using <code class="w3-codespan">
                        AND</code> or <code class="w3-codespan">OR</code> operators.</p>
            </div>

            <p>Here are some examples showing different <code class="w3-codespan">LIKE</code> operators with '%' and '_' wildcards:</p>
            ...
            <p>The following SQL statement selects all customers with a CustomerName starting with 
                "a":</p>
            <div class="w3-example">
                <h3>Example</h3>
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> CustomerName <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'a%'</span>; </span></div>
            ...
            <p>The following SQL statement selects all customers with a CustomerName that 
                have "or" in any position:</p>
            <div class="w3-example">
                <h3>Example</h3>
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> * <span class="sqlkeywordcolor" style="color:mediumblue">FROM</span> Customers<br><span class="sqlnumbercolor" style="color:">
                        </span>  <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> CustomerName <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'%or%'</span>;<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>

            </div>

            <p>The following SQL statement selects all customers with a CustomerName that 
                have "r" in the second position:</p>
            <div class="w3-example">
                <h3>Example</h3>
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> * <span class="sqlkeywordcolor" style="color:mediumblue">FROM</span> Customers<br><span class="sqlnumbercolor" style="color:">
                        </span>  <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> CustomerName <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'_r%'</span>;<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>

            </div>
            <p>The following SQL statement selects all customers with a CustomerName that 
                starts with "a" and are at least 3 characters in length:</p>
            <div class="w3-example">
                <h3>Example</h3>
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> * <span class="sqlkeywordcolor" style="color:mediumblue">FROM</span> Customers<br><span class="sqlnumbercolor" style="color:">
                        </span>  <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> CustomerName <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'a__%'</span>; </span></div>

            </div>

            <p>The following SQL statement selects all customers with a ContactName that 
                starts with "a" and ends with "o":</p>
            <div class="w3-example">
                <h3>Example</h3>
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        </span> <span class="sqlkeywordcolor" style="color:mediumblue">SELECT</span> * <span class="sqlkeywordcolor" style="color:mediumblue">FROM</span> Customers<br><span class="sqlnumbercolor" style="color:">
                        </span>  <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> ContactName <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'a%o'</span>; </span></div>
            ...
            <div class="w3-example">
                ...
                <div class="w3-code notranslate sqlHigh"><span class="sqlcolor" style="color:black"><span class="sqlnumbercolor" style="color:">
                        ...
                        </span>  <span class="sqlkeywordcolor" style="color:mediumblue">WHERE</span> CustomerName <span class="sqlkeywordcolor" style="color:mediumblue">NOT</span> <span class="sqlkeywordcolor" style="color:mediumblue">LIKE</span> <span class="sqlstringcolor" style="color:brown">'a%'</span>;<span class="sqlnumbercolor" style="color:">
                        </span> </span></div>
