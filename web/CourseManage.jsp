        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <div class="input-group">
                    <a href="#searchCourse" data-toggle="modal" >
                    ...
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h2 style="color: red">Manager <b style="color: red">Course</b></h2>
                                    ...
                                    <c:forEach items="${requestScope.listC}" var="course">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="chapter?id=${course.getCourse_id()}" class="edit" ><i class="material-icons" title="Edit">&#xE254;</i></a>
<!--                                                <a href="#" onclick="doDelete('${u.getUser_id()}')" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>-->
                ...
                <div id="searchCourse" class="modal fade">
