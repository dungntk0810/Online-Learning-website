<%-- 
    Document   : LessonManage
    Created on : Feb 24, 2023, 3:26:16 PM
    Author     : admin
--%>
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <div class="input-group">
                    <a href="#searchLesson" data-toggle="modal" >
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h2 style="color: red">Manager <b style="color: red">Lesson</b></h2>
                                        <h4><a href="usermanage" ><i class="fa-solid fa-circle-arrow-left"></i></a></h4>

                                    </div>
                                    <div class="col-sm-6">  
                                        <a href="#addlesson" data-toggle="modal" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Add New Lesson</span></a>
                                    </div>
                                </div>
                            </div>
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.listL}" var="lesson">
                                        <tr>
                                            <td>${lesson.getLesson_id()}</td>
                                            <td>
                                                <c:if test="${lesson.getLesson_video()==null}">
                                                    <i class="fa-sharp fa-solid fa-video"></i>
                                                </c:if>                                               
                                            </td> 
                                            <td>
                                                ${lesson.getLesson_level()}
                                            </td> 
                                            <td>${lesson.getChapter_id() }</td>                                   
                                            <td>${lesson.getLesson_content()}</td>
                                            <td>
                        ...
                        <div class="modal-content">                   
                            <form action="searchlesson">
                                ...
                                <div class="modal-body">					
                                    ...
                                    <div >
                                        ChapterID
                                        <input type="text" class="form-control" readonly name="chapterid"value="${requestScope.index}" >
                                    </div> 
                                    <div >
                                        Content
                ...
                <div id="addlesson" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">                   
                            <form action="addlesson" method="post">
                                ...
                                <div class="modal-body">					
                                    ...
                                    <div >
                                        CourseID
                                        <input type="text" class="form-control" readonly name="cid"value="${requestScope.cid}" >
                                    </div> 
                                    <div >
                                        Content
