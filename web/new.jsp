                        ...
                        <div class="container" style="margin-top: 20px">
                            <div class="row">
                                ...
                                <div class="col-md-6  col-sm-4  col-xs-12" style="text-align: right">
                                    <a href="/html/post.html" class="btn btn-success standard-button create">
                                            ...
                                            <div class="forum-thread-item">
                                                <div class="user-info-container">
                                                    ...
                                                    <div><a href="/discussion/topic/21378433"
                                                            class="forum-thread-title">View detail</a>
                                                        <div>
                                                            <div><span class="forum-thread-content">hi guys I just want to
                                                                    annouce they have a big anoucement coming tomorrownew
                                                                    fights battles will come such as battles royalit is new
                                                                    in code learnso it is all </span></div>
                                                        </div>
                                                        <img src="upload/834856.png" alt="" style="height: 90px; width: 100px;"> 
                                                        <div class="thread-summary">
                                                            <div>By <span class="created-by"><a
                                                                        href="/profile/21378411">Cameroonboy</a></span><a
                                                                    href="/profile/21378411"><span
                                                                        class="category hide">null</span></a>Last update:
                                                                <span class="last-update">7 days ago</span></div>
                                                        </div>
                                                    </div>
