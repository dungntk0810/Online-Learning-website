                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <span class="change-lang"
                                                          data-link="/language/setLanguageLocal?name=en&redirectUrl=%2f">
                                                        <img alt="en" class="icon-language" src="themes/en.png">
                                                        English
                                                    </span>
                                                </li>
                                                <li>
                                                    <span class="change-lang"
                                                          data-link="/language/setLanguageLocal?name=vn&redirectUrl=%2f">
                                                        <img alt="vn" class="icon-language" src="themes/vn.png">
                                                        Tiếng Việt
                                                    </span>
                                                </li>
                                            </ul>
